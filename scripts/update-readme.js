    ...
    for (let item of playlist.items) {
      ...
      if (countries[countryCode]) {
        ...
        countries[countryCode] = {
          ...
          channels: 1,
          playlist: `<code>https://github.com/KodiTVR-add-on/iptv/countries/${countryCode}.m3u</code>`,
          epg: countryEpg
        }
      }
      ...
      for (let languageName of languageNames.split(';')) {
        ...
        if (languages[languageCode]) {
          ...
          languages[languageCode] = {
            ...
            channels: 1,
            playlist: `<code>https://github.com/KodiTVR-add-on/iptv/languages/${languageCode}.m3u</code>`
          }
        }
      }
      ...
      if (categories[categoryCode]) {
        ...
        categories[categoryCode] = {
          ...
          channels: 1,
          playlist: `<code>https://github.com/KodiTVR-add-on/iptv/categories/${categoryCode}.m3u</code>`
        }
      }
    }
  }
